...
### 1. Purpose of Data Processing and Items Collected
The App prioritizes user privacy and does not require any membership or registration. We do not store or transmit any identifiable user information (name, email, phone number, etc.) to external servers.
...
The App does not provide user information to third parties nor entrusts data processing to external companies. If a user sends a support inquiry, their email address may be used solely for consultation and will be deleted immediately after the purpose is achieved.
...
*   **Personal Information Infringement Reporting Center**: 118 ([privacy.kisa.or.kr](https://privacy.kisa.or.kr))
*   **Supreme Prosecutors' Office Cyber Investigation Division**: 1301 ([www.spo.go.kr](https://www.spo.go.kr))
*   **Korean National Police Agency Cyber Bureau**: 182 ([ecrm.police.go.kr](https://ecrm.police.go.kr))

### 8. Notification of Changes
This policy is effective as of the implementation date. Any additions, deletions, or modifications due to changes in laws or policies will be notified in advance through app updates or store descriptions.
